...
const scripting_api_extra_1 = require("@workadventure/scripting-api-extra");
...
WA.onInit().then(() => {
    ...
    (0, scripting_api_extra_1.bootstrapExtra)().then(() => {
